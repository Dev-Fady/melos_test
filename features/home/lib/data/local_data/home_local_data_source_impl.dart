...
class HomeLocalDataSourceImpl implements HomeLocalDataSource {
  ...
  Future<void> cacheHomeData({required HomeModel homeModel}) async {
    ...
    await SecureStorage.write(
        key: AppConstants.cachedHomeKey, value: jsonString);
  }

  @override
  Future<void> clearCachedHomeData() async {
    await SecureStorage.delete(key: AppConstants.cachedHomeKey);
  }

  @override
  Future<HomeModel?> getCachedHomeData() async {
    final jsonString =
        await SecureStorage.read(key: AppConstants.cachedHomeKey);
    if (jsonString != null) {
      return HomeModel.fromJson(jsonDecode(jsonString));
    }
    return null;
